...
public isolated client class Client {
    ...
    remote isolated function deleteAuthToken(DeleteAuthTokenHeaders headers = {}) returns error? {
        string resourcePath = string `/token`;
        map<anydata> headerValues = {...headers};
        if self.apiKeyConfig is ApiKeysConfig {
            headerValues["X-PriceFx-jwt"] = self.apiKeyConfig?.xPriceFxJwt;
    ...
    # + queries - Queries to be sent with the request 
    # + return - OK 
    remote isolated function downloadFileViaPost(string typedId, string binaryDataId, map<string|string[]> headers = {}, *DownloadFileViaPostQueries queries) returns FileOperationEnvelope|error {
        string resourcePath = string `/bdmanager.download/${getEncodedUri(typedId)}/${getEncodedUri(binaryDataId)}`;
        map<anydata> headerValues = {...headers};
        if self.apiKeyConfig is ApiKeysConfig {
            headerValues["X-PriceFx-jwt"] = self.apiKeyConfig?.xPriceFxJwt;
    ...
    # # Deprecated
    @deprecated
    remote isolated function changeTermsOfUse(AccountmanagerChangetermsofuseBody payload, map<string|string[]> headers = {}) returns error? {
    ...
    remote isolated function deleteInternationalizationMessages(I18nmanagerDeleteKeysBody payload, map<string|string[]> headers = {}) returns error? {
    ...
    remote isolated function loadDataIntoFieldCollection(string typedId, DatamartLoadfctypedIdBody payload, map<string|string[]> headers = {}) returns error? {
    ...
    # + headers - Headers to be sent with the request 
    # + return - OK 
    remote isolated function executeLibraryFunction(string formulaName, string elementName, string functionName, ElementNamefunctionNameBody payload, map<string|string[]> headers = {}) returns error? {
    ...
    # + headers - Headers to be sent with the request 
    # + return - OK 
    remote isolated function massEditImports(string typedId, ImportmanagerMassedittypedIdBody payload, map<string|string[]> headers = {}) returns error? {
