...
// package root and callers do not need to import the `oas` submodule. The generated
// `ConnectionConfig` is omitted, since the root module declares its own richer one.
// Regenerate it by copying that file whenever the `oas` submodule is regenerated.
